...
ZSH=".zshrc .zprofile"
CONFIG=".config/yay/ .config/nvim/init.lua .config/nvim/lua/ .config/nvim/after/ .config/rofi/ .config/bspwm/ .config/picom/ .config/sxhkd/ .config/polybar/ .config/gtk-2.0/ .config/gtk-3.0/  .config/alacritty/alacritty.toml"
