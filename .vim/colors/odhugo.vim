...
execute 'hi Directory guifg= ' . s:blue . ' guibg= ' . s:bg . ' gui= ' . s:NONE . ' cterm= ' . s:NONE
...
execute 'hi Todo guifg= ' . s:yellow . ' guibg= ' . s:green . ' gui= ' . s:NONE . ' cterm= ' . s:NONE
execute 'hi Type guifg= ' . s:cyan . ' guibg= ' . s:NONE . ' gui= ' . s:NONE . ' cterm= ' . s:NONE
